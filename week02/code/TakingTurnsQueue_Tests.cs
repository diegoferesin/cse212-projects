...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() adds to front instead of back, causing wrong order. 
    // TakingTurnsQueue.GetNextPerson() has incorrect logic for handling turns (should check >0 not >1).
